            ...
            <c:if test="${empty mode}">
                <main class="w-full max-w-[480px] mx-auto z-10 relative animate-fade-in mt-16">
                    <div class="glass-card p-8 md:p-10">
                        ...
                        <!-- Social Buttons -->
                        <div class="mb-8">
                            <a href="https://accounts.google.com/o/oauth2/v2/auth?client_id=392403100271-apt84m1lcgr7l581fhpkfbginiak48jv.apps.googleusercontent.com&redirect_uri=https://finalprojectcourse-production.up.railway.app/login-google&response_type=code&scope=openid%20email%20profile&prompt=select_account"
