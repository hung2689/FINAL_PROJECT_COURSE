    ...
    <div class="relative flex min-h-screen w-full flex-col">
        ...
        <main class="flex-1">
            <section class="relative min-h-screen flex items-center justify-center overflow-hidden">
                ...
                <div class="max-w-canvas mx-auto px-6 lg:px-12 relative z-10 text-center flex flex-col items-center pt-20">
                    ...
                    <h1 class="text-6xl md:text-7xl lg:text-[5.5rem] font-black leading-[1.1] tracking-tighter mb-8 text-white max-w-5xl mx-auto drop-shadow-2xl animate-fade-up delay-2">
                        Build Your Future <br class="hidden md:block" /> with a Modern
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-400 drop-shadow-[0_0_40px_rgba(20,184,166,0.3)]">Digital
                            Learning Platform</span>
                    </h1>

                    <div class="flex flex-col sm:flex-row items-center gap-6 justify-center w-full relative z-20 animate-fade-up delay-3">
                        <button class="relative w-full sm:w-auto h-[4.5rem] px-12 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white text-xl font-bold rounded-full shadow-[0_0_40px_rgba(16,185,129,0.4)] hover:shadow-[0_0_60px_rgba(16,185,129,0.6)] hover:scale-105 transition-all duration-300 flex items-center justify-center gap-3 group">
                            <span class="relative z-10 flex items-center gap-3">
                                ...
                                <span class="material-symbols-outlined font-bold transform transition-transform group-hover:translate-x-2">arrow_forward</span>
                            </span>
                        </button>
                    </div>
                </div>
                    ...
                    <div class="bg-white rounded-3xl shadow-2xl border border-emerald-100 py-12">
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                            <div class="flex flex-col items-center gap-2">
                                ...
                                <span class="text-sm font-semibold uppercase tracking-widest text-slate-500">Advanced Courses</span>
                            </div>
                            <div class="flex flex-col items-center gap-2">
                                <span class="text-4xl font-black text-primary">50+</span>
                                <span class="text-sm font-semibold uppercase tracking-widest text-slate-500">Experienced Mentors</span>
                            </div>
                            <div class="flex flex-col items-center gap-2">
                                <span class="text-4xl font-black text-primary">24/7</span>
                                <span class="text-sm font-semibold uppercase tracking-widest text-slate-500">Technical Support</span>
                            </div>
                            <div class="flex flex-col items-center gap-2">
                                <span class="text-4xl font-black text-primary">100%</span>
                                <span class="text-sm font-semibold uppercase tracking-widest text-slate-500">Hands-on Practice</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="py-12 lg:py-10">
                <div class="max-w-canvas mx-auto px-8 lg:px-12">
                    <div class="flex flex-col lg:flex-row lg:items-end justify-between mb-16 gap-8">
                        <div class="max-w-xl">
                            <h2 class="text-4xl font-black tracking-tight bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent">
                    ...
                    <div class="slider relative">
                        <button class="slider-prev absolute left-0 -translate-x-1/2 top-1/2 -translate-y-1/2 z-10 w-12 h-12 rounded-full bg-white border border-emerald-200 text-slate-600 shadow-lg flex items-center justify-center hover:scale-110 hover:bg-emerald-50 transition">
                            <span class="material-symbols-outlined">chevron_left</span>
                        </button>
                        <button class="slider-next absolute right-0 translate-x-1/2 top-1/2 -translate-y-1/2 z-10 w-12 h-12 rounded-full bg-white border border-emerald-200 text-slate-600 shadow-lg flex items-center justify-center hover:scale-110 hover:bg-emerald-50 transition">
                            <span class="material-symbols-outlined">chevron_right</span>
                        </button>
                        <div class="slider-wrapper overflow-x-auto snap-x snap-mandatory w-full relative">
                            <div class="slider-track flex gap-6 transition-transform duration-500 ease-in-out">
                                <c:forEach var="c" items="${FREE}">
                                    <div class="group w-[280px] lg:w-[calc(25%-18px)] flex-shrink-0 snap-start flex flex-col bg-white rounded-[2rem] overflow-hidden border border-emerald-100 hover:border-emerald-400/50 hover:shadow-[0_20px_40px_-15px_rgba(16,185,129,0.2)] transition-all duration-300 cursor-pointer"
                                        onclick="window.location.href = '${pageContext.request.contextPath}/course-detail?id=${c.courseId}'">
                                        <div class="aspect-[16/10] overflow-hidden relative">
                                            <img alt="Thumbnail" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" src="${c.thumbnailUrl}" />
                                        </div>
                                        <div class="p-6 flex flex-col flex-grow">
                                            <div class="flex items-center gap-2 mb-3">
                                                <span class="text-[10px] font-bold text-primary bg-primary/10 px-2 py-1 rounded">${c.categoryId != null ? c.categoryId.name : 'No Category'}</span>
                                                <span class="text-xs text-gray-400">• 12 Hours</span>
                                            </div>
                                            <h3 class="text-xl font-bold mb-3 leading-tight group-hover:text-primary transition-colors line-clamp-2">
                                                ${c.title}</h3>
