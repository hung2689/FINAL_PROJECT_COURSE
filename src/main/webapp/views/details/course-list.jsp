<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        .range-fill {
            position: absolute; height: 4px; background: linear-gradient(90deg, #10B981, #14b8a6);
        ...
        .card-animate { animation: cardIn 0.4s cubic-bezier(0.22, 1, 0.36, 1) forwards; }
                                            ...
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <c:forEach var="c" items="${courses}" varStatus="idx">
                                                        <div class="course-card card-animate group flex flex-col bg-white rounded-2xl overflow-hidden border border-emerald-100 hover:border-emerald-400/50 hover:shadow-[0_20px_40px_-15px_rgba(16,185,129,0.2)] transition-all duration-300"
