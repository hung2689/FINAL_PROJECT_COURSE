                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                        ...
                                        <c:forEach var="entry" items="${sessionScope.cart}">
                                            ...
                                            <div
                                                ...
                                                <div class="absolute bottom-5 right-5 delete-container">
                                                    <button type="button"
                                                        onclick="toggleDeletePopup('popup-${course.courseId}')"
                                                        class="text-slate-300 hover:text-red-500 transition-colors focus:outline-none">
                                                        <span
                                                            class="material-symbols-outlined text-[24px]">delete</span>
                                                    </button>
                                                    <div id="popup-${course.courseId}"
                                                        class="hidden absolute bottom-full right-0 mb-3 w-[300px] bg-white rounded-xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.25)] border border-slate-100 p-4 z-50 transform origin-bottom-right transition-all">
                                                        <div
                                                            class="absolute -bottom-2 right-2 w-4 h-4 bg-white border-b border-r border-slate-100 transform rotate-45">
                                                        </div>
                                                        <div class="relative z-10">
                                                            <div class="flex items-center gap-2 mb-4">
                                                                <span
                                                                    class="material-symbols-outlined text-red-500 text-[24px]">help</span>
                                                                <p class="text-[15px] font-medium text-slate-700 m-0">
                                                                    Remove this course from cart?</p>
                                                            </div>
                            ...
                            <div class="lg:col-span-1">
                                <div
                                    ...
                                    <div class="mb-6">
                                        <label class="block text-[13px] font-bold text-slate-700 mb-2">Promo
                                            Code</label>
                                        <div class="flex gap-2">
                                            ...
                                            <button
                                                class="bg-slate-800 text-white px-5 py-2.5 rounded-lg text-sm font-bold hover:bg-slate-700 whitespace-nowrap transition-colors">Apply</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-center justify-between mb-8 pb-6 border-b border-slate-100">
                                        <div>
                                            ...
                                            <p class="text-[11px] text-slate-400 mt-0.5">Total: 0 pts <span
                                                    class="ml-1">(100 pts = $1.00)</span></p>
                                        </div>
                                        <div
                                            ...
                                            <label for="toggle"
                                                class="toggle-label block overflow-hidden h-5 rounded-full bg-slate-300 cursor-pointer transition-colors duration-200 ease-in-out"></label>
                                        </div>
                                    </div>
                            ...
                            <div class="mt-20 pt-10 border-t border-slate-100">
                                ...
                                <div class="relative group/slider">
                                    ...
                                    <button id="btnSlideRight"
                                        class="absolute -right-5 top-1/2 -translate-y-1/2 w-11 h-11 bg-white rounded-full flex items-center justify-center text-slate-400 hover:text-primary shadow-[0_4px_15px_rgba(0,0,0,0.1)] border border-slate-100 z-10 opacity-0 group-hover/slider:opacity-100 transition-all duration-300 transform scale-90 hover:scale-110">
