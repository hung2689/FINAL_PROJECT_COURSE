                    ...
                    <c:when test="${not empty suggestedCourses}">
                        <div class="relative group/slider">
                            <button id="btnSlideLeft"
                                class="absolute -left-5 top-[40%] -translate-y-1/2 w-11 h-11 bg-white rounded-full flex items-center justify-center text-slate-400 hover:text-primary shadow-[0_4px_15px_rgba(0,0,0,0.1)] border border-slate-100 z-10 transition-all duration-300 transform scale-90 hover:scale-110 opacity-0 pointer-events-none">
                                <span class="material-symbols-outlined text-[24px]">chevron_left</span>
                            </button>

                            <div id="suggestedSlider" class="flex gap-6 overflow-x-auto snap-x snap-mandatory pb-6 no-scrollbar select-none cursor-grab active:cursor-grabbing scroll-smooth">
                                    ...
                                    <div class="snap-start flex-shrink-0 w-full sm:w-[calc(50%-12px)] lg:w-[calc(25%-18px)]">
                                        <div class="bg-white rounded-2xl border border-emerald-100 overflow-hidden hover:-translate-y-1 hover:shadow-lg transition-all duration-300 flex flex-col group h-full">
                                            <a href="${pageContext.request.contextPath}/course?id=${sc.courseId}"
                                                ...
                                                <img class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500 pointer-events-none"
