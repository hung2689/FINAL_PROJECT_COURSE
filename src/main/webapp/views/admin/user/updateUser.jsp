    ...
    <%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
        <div class="bg-white dark:bg-slate-900 rounded-2xl w-full max-w-2xl overflow-hidden shadow-2xl relative">
            <div class="flex items-center justify-between p-6 border-b border-slate-200 dark:border-slate-800">
                <h3 class="text-xl font-bold text-slate-900 dark:text-white">Update User</h3>
            ...
            <form id="updateUserForm" action="${pageContext.request.contextPath}/userAdmin" method="post" class="p-6">
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">Full
                            Name</label>
                        <input type="text" name="fullName" id="updateFullName" required
                    ...
                    <div>
                        <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">Password (Leave
                    ...
                    <div>
                        ...
                        <input type="number" name="studyCoins" id="updateStudyCoins" min="0" value="0"
                            class="w-full px-4 py-2.5 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-primary/50"
                            placeholder="0" />
                    </div>
                </div>
                <div class="mt-8 flex justify-end gap-3 border-t border-slate-200 dark:border-slate-800 pt-6">
                    ...
                    <button type="submit"
                        class="bg-primary text-background-dark font-bold px-5 py-2.5 rounded-lg hover:shadow-lg hover:shadow-primary/30 transition-all">Submit
                        Update</button>
                </div>
            </form>
        </div>