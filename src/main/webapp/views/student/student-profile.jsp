    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            ...
            <body class="font-display bg-gradient-to-br from-slate-50 to-emerald-50 min-h-screen text-slate-800">
                                    ...
                                    <%-- Error --%>
                                        ...
                                        <div class="bg-white rounded-2xl shadow-sm border border-slate-100">
                                            <div class="px-8 py-6 border-b border-slate-100">
                                                ...
                                                <p class="text-sm text-slate-400 mt-0.5">Manage your personal
                                                    information</p>
                                            </div>
                                                ...
                                                <%-- Full Name --%>
                                                    ...
                                                    <%-- Email (readonly) --%>
                                                        <div class="space-y-1.5">
                                                            ...
                                                            <p class="text-xs text-slate-400">Email cannot be changed.
                                                            </p>
                                                        </div>
                                                        ...
                                                        <%-- Date of Birth --%>
                                                            <div class="space-y-1.5">
                                                                ...
                                                                <input id="dateOfBirth" name="dateOfBirth" type="date"
                                                                    <c:if
                                                                    test="${profileStudent != null && profileStudent.dateOfBirth != null}">
                                                                value="
                                                                <fmt:formatDate value='${profileStudent.dateOfBirth}'
                                                                    pattern='yyyy-MM-dd' />"
                                                                </c:if>
                                                                class="w-full px-4 py-2.5 rounded-xl border
                                                                border-slate-200 bg-slate-50 focus:ring-2
                                                            ...
                                                            <%-- Level --%>
                                                                <div class="space-y-1.5">
                                                                    <label
                                                                        class="block text-sm font-semibold text-slate-700"
                                                                        for="level">Learning Level</label>
                                                                    <select id="level" name="level"
                                                                        class="w-full px-4 py-2.5 rounded-xl border border-slate-200 bg-slate-50 focus:ring-2 focus:ring-emerald-400 focus:border-emerald-400 outline-none transition text-slate-800 text-sm">
                                                                        <c:set var="currentLevel"
                                                                            value="${profileStudent != null ? profileStudent.level : ''}" />
                                                                        <option value="" ${empty currentLevel
                                                                            ? 'selected' : '' }>— Select level —
                                                                        </option>
                                                                        <option value="BEGINNER"
                                                                            ${currentLevel=='BEGINNER' ? 'selected' : ''
                                                                            }>Beginner</option>
                                                                        <option value="INTERMEDIATE"
                                                                            ${currentLevel=='INTERMEDIATE' ? 'selected'
                                                                            : '' }>Intermediate</option>
                                                                        <option value="ADVANCED"
                                                                            ${currentLevel=='ADVANCED' ? 'selected' : ''
                                                                            }>Advanced</option>
                                                                    </select>
                                                                </div>
                ...
                <script>
                    // Auto-hide success toast after 4 s
